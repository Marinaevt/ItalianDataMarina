...
%     s0 = s0(1);
    ...
    for i = 1:numel(P)
     ...
     [X_min, Err] = fminsearchbnd(@(x)minsearcher3(H_exp, P, s0, Rho0, R0, t, x(1), x(2), x(3), x(4)), [A1, A2, A3, A4], [0 0 inf inf], [inf inf 0 0], optimset('Display', 'iter', 'MaxFunEvals', 3000));   
     X_min
     Err
     Pstart = P(1);
     Y(end) = 1;
